...
document.querySelectorAll(".module-card").forEach((card) => {
  ...
  card.addEventListener("mouseleave", () => {
    ...
    card.style.transition =
      "transform 0.45s ease, background 0.25s ease, border-color 0.25s ease";
  });
  card.addEventListener("mouseenter", () => {
    card.style.transition =
      "transform 0.08s ease, background 0.25s ease, border-color 0.25s ease";
  });
});
...
const PROJECTS = [
  {
    num: "01",
    name: "Cardano Intel Agent",
    name_zh: "Cardano Intel Agent",
    status: "ACTIVE",
    status_zh: "运行中",
    summary:
      "An automated blockchain intelligence system powered by CrewAI and Llama 3, monitoring Cardano (ADA) technical developments and market sentiment in real-time.",
    summary_zh:
      "由 CrewAI + Llama 3 驱动的自动化区块链情报系统，实时监控 Cardano (ADA) 的技术动态与市场情绪。",
  ...
  {
    num: "02",
    name: "Stonepark Chromebook Borrowing System",
    name_zh: "Stonepark Chromebook 借用系统",
    status: "ACTIVE",
    status_zh: "运行中",
    summary:
      "A full-stack web application for managing the borrowing and reservation of Chromebooks at Stonepark Intermediate School, including charging cabinets and individual devices.",
    summary_zh:
      "用于管理 Stonepark 中学 Chromebook 借用和预约的全栈网页应用程序，包括充电柜和个人设备。",
  ...
  },
  {
    ...
    status_zh: "MVP",
    summary:
      "A decentralized on-chain content platform built on Cardano. Publish freely, receive AI+DAO review, mint NFT proof, and earn revenue share automatically via smart contracts.",
    summary_zh:
      "建立在 Cardano 上的去中心化链上内容平台。自由发布内容，获得 AI+DAO 审核，铸造 NFT 证明，通过智能合约自动分享收益。",
...
[→ 加入 EchoForge Discord](https://discord.gg/8tjzmjQmpW)`,
  },
  {
    ...
    status_zh: "运行中",
    summary:
      "This website — a structured, minimal personal operating system representing my thinking and output in public.",
    summary_zh:
      "本网站——一个结构化、极简的个人操作系统，公开记录我的思考与产出。",
  ...
  },
  {
    num: "05",
    name: "HP Web Runner",
    name_zh: "HP Web Runner",
    status: "ARCHIVED",
    status_zh: "已归档",
    summary:
      "Web application runner for server-side execution and deployment pipeline testing.",
  ...
  {
    num: "06",
    name: "Cardano Aiken LLM",
    name_zh: "Cardano Aiken LLM",
    status: "ACTIVE",
    status_zh: "运行中",
    summary:
      "A Cardano-native LLM experiment built with Aiken and shared on Hugging Face, exploring how on-chain logic and AI workflows can meet.",
    summary_zh:
      "一个使用 Aiken 构建并发布在 Hugging Face 上的 Cardano 原生 LLM 实验，探索链上逻辑与 AI 工作流如何结合。",
  ...
  },
  {
    ...
    status_zh: "持续进行",
    summary:
      "A family-focused toolbox for systematically managing recurring chores, schedules, reminders, documents, and the small tasks that keep a household organized.",
    summary_zh:
      "一个面向家庭的工具箱，用于系统化管理重复琐事、日程、提醒、文档，以及维持家庭有序运行的细碎事务。",
...
ESSAYS.push({
  type: "note",
  title:
    "Stickman Charles — Business Analysis——Why Is Cardano (ADA) Valued So Low? -V2",
  title_zh:
    "Stickman Charles的商业分析——为什么Cardano（ADA）的市值这么低？- V2",
  date: "2025/12/4",
  readTime: "",
...
const MILESTONES = [
  {
    ...
    items: [
      {
        date: "2023",
        title: "Invested in NASDAQ 100 Index Fund",
        title_zh: "投资纳斯达克100指数基金",
        desc: "Made my first investment in the NASDAQ 100, marking the start of my financial journey.",
        desc_zh: "完成纳斯达克100的首次投资，开启了我的财务旅程。",
        major: true,
        tag: "INVEST",
      },
      {
        date: "2023",
        title:
          "Joined Nanjing Beijing East Road Primary School Student Council",
        title_zh: "进入南京北京东路小学大队部",
        desc: "Became a member of the student council, starting my leadership journey.",
        desc_zh: "成为大队部成员，开启领导力之路。",
        major: true,
        tag: "LEADERSHIP",
      },
    ],
  },
  {
    ...
    items: [
      {
        date: "2024-01-21",
        title: "First Encounter with AI Art, Music, and Writing",
        title_zh: "初次接触 AI 艺术、音乐与写作",
        desc: "Explored generative AI for the first time, creating art, music, and written works with cutting-edge tools.",
        desc_zh: "首次探索生成式 AI，用前沿工具创作艺术、音乐与文字作品。",
        major: true,
        tag: "AI",
      },
      {
        date: "2024-01-26",
        title: "Dogs Travel Startup Event I",
        title_zh: "狗狗旅行创业活动 I",
        desc: "Organized and led the first Dogs Travel startup event, traveling to Yangzhou with an enthusiastic group to experience the city's local culture and atmosphere.",
        desc_zh:
          "组织并主导了第一届狗狗旅行创业活动，与热情的伙伴共同奔赴扬州，领略当地的风土人情。",
        major: true,
        tag: "STARTUP",
      },
      {
        date: "2024-05-01",
        title: "Dogs Travel Startup Event II",
        title_zh: "狗狗旅行创业活动 II",
        desc: "Held the second Dogs Travel startup event in Hefei, refined the method, and expanded the market scale.",
        desc_zh: "在合肥举办第二届狗狗旅行创业活动，总结方法并扩大了市场规模。",
        major: true,
        tag: "STARTUP",
      },
      {
        date: "2024-11",
        title: "Python NCT Level 1 Excellence",
        title_zh: "Python NCT 一级优秀",
        desc: "Achieved excellent results in the Python NCT Level 1 exam, demonstrating strong programming fundamentals.",
        desc_zh: "在 Python NCT 一级考试中取得优秀成绩，展现扎实的编程基础。",
        major: false,
        tag: "Code",
      },
    ],
  },
  {
    ...
    items: [
      {
        date: "2025-03-03",
        title: "First Blockchain Experience & Investment",
        title_zh: "首次区块链体验与投资",
        desc: "Dove into blockchain technology and made my first investment, opening a new chapter in tech and finance.",
        desc_zh: "深入区块链技术并完成首次投资，开启科技与金融融合的新篇章。",
        major: true,
        tag: "BLOCKCHAIN",
      },
      {
        date: "2025-05-14",
        title:
          "Codemao Exploring the Moon Cup AI Programming Championship First Prize",
        title_zh: "Codemao 探月杯AI创编大赛 一等奖",
        desc: "Won first prize in the Codemao Exploring the Moon Cup AI Programming Championship.",
        desc_zh: "荣获 Codemao 探月杯AI创编大赛一等奖。",
        major: true,
        tag: "Code",
      },
      {
        date: "2025-06-06",
        title: "Invested in TSLA",
        title_zh: "投资特斯拉",
        desc: "Added Tesla to my investment portfolio, betting on innovation and the future of mobility.",
        desc_zh: "将特斯拉纳入投资组合，押注创新与出行的未来。",
        major: false,
        tag: "INVEST",
      },
      {
        date: "2025-06-15",
        title: "Admitted to Codemao Python Talent Class with Full Score",
        title_zh: "满分入选编程猫科技特长生Python班",
        desc: "Selected for Codemao Python Talent Class with a perfect score.",
        desc_zh: "以满分成绩入选编程猫科技特长生Python班。",
        major: true,
        tag: "Code",
      },
      {
        date: "2025-07-05",
        title:
          "National Youth Labor Skills & Intelligent Design Competition Python Silver Medal",
        title_zh: "全国青少年劳动技能与智能设计大赛Python中学组银牌",
        desc: "Won the Silver Medal in the National Youth Labor Skills & Intelligent Design Competition (Python, Middle School Group).",
        desc_zh: "获得全国青少年劳动技能与智能设计大赛Python中学组银牌。",
        major: true,
        tag: "Code",
      },
      {
        date: "2025-08-06",
        title: "Completed Integrated Math I Honors",
        title_zh: "完成Integrated Math I荣誉课程",
        desc: "Completed the Integrated Math I Honors course.",
        desc_zh: "完成Integrated Math I荣誉课程。",
        major: true,
        tag: "MATH",
      },
      {
        date: "2025-08-10",
        title: "Published First Collaborative AI Research on Zenodo",
        title_zh: "在Zenodo上传首个多人合作AI研究项目",
        desc: "Published the collaborative AI research: Tao Chengfeng, C. T., Cheng Jiale, J. C., & Tong Yiyan, S. T. (2025). 6 AI Mathematics Ability Assessments. Zenodo. https://doi.org/10.5281/zenodo.17317013",
        desc_zh:
          "陶乘风, C. T., 程嘉乐, J. C., & 童一焱, S. T. (2025). 6 AI Mathematics Ability Assessments. Zenodo. https://doi.org/10.5281/zenodo.17317013",
        major: true,
        tag: "AI",
      },
      {
        date: "2025-08-12",
        title: "Eero Router Heat Disconnect Experiment",
        title_zh: "Eero散热工程",
        desc: "Completed and published the Eero Router Heat Disconnect Experiment on Instructables, exploring thermal management solutions for networking hardware.",
        desc_zh:
          "在 Instructables 上发布 Eero 散热工程项目，探索网络硬件的散热管理解决方案。",
        major: false,
        tag: "HARDWARE",
      },
      {
        date: "2025-09-14",
        title: "Cardano Academy Master Level",
        title_zh: "Cardano 学院大师级",
        desc: "Achieved Master Level at Cardano Academy, deepening my understanding of blockchain and smart contracts.",
        desc_zh:
          "在 Cardano 学院取得大师级认证，深化了对区块链与智能合约的理解。",
        major: true,
        tag: "Blockchain",
      },
      {
        date: "2025-09-28",
        title: "Graduated from Codemao Advanced Python",
        title_zh: "完成编程猫Python高阶，顺利毕业",
        desc: "Graduated from Codemao Advanced Python course.",
        desc_zh: "完成编程猫Python高阶课程，顺利毕业。",
        major: true,
        tag: "Code",
      },
      {
        date: "2025-12-21",
        title: "Launched First C++ Website: HP Web Runner",
        title_zh: "发布首个 C++ 网站：HP Web Runner",
        desc: "Deployed HP Web Runner, my first website built with C++, marking a milestone in my systems programming journey.",
        desc_zh:
          "部署了 HP Web Runner，我第一个用 C++ 构建的网站，标志着系统编程旅程的重要里程碑。",
        major: true,
        tag: "Code",
      },
      {
        date: "2025-12-21",
        title: "Completed StoryForge DAO MVP",
        title_zh: "完成 StoryForge DAO MVP",
        desc: "Finished and launched the MVP for my blockchain startup project, StoryForge DAO.",
        desc_zh: "完成并发布区块链创业项目 StoryForge DAO 的最小可行产品。",
        major: true,
        tag: "Startup",
      },
    ],
  },
  {
    ...
    items: [
      {
        date: "2026-02-28",
        title: "Launched stickmancharles.me",
        title_zh: "发布 stickmancharles.me",
        desc: "Released my personal website, stickmancharles.me, to share my work and ideas with the world.",
        desc_zh: "发布个人网站 stickmancharles.me，向世界分享我的作品与想法。",
        major: true,
        tag: "Code",
      },
      {
        date: "2026-03-04",
        title: "First Cardano Aiken LLM",
        title_zh: "首个 Cardano Aiken 大语言模型",
        desc: "Deployed my first LLM using Cardano Aiken, pushing the boundaries of blockchain AI integration.",
        desc_zh:
          "使用 Cardano Aiken 部署首个大语言模型，突破区块链 AI 融合的边界。",
        major: true,
        tag: "AI",
      },
      {
        date: "2026-03-04",
        title: "EchoForgeDAO MVP Complete",
        title_zh: "EchoForgeDAO MVP 完成",
        desc: "Completed the MVP for my blockchain project EchoForgeDAO, advancing decentralized content creation.",
        desc_zh:
          "完成区块链项目 EchoForgeDAO 的 MVP，推动去中心化内容创作向前迈进。",
        major: true,
        tag: "Startup",
      },
      {
        date: "2026-03-06",
        title: "Read 5,234,000 Words of Literature",
        title_zh: "累计阅读 523 万字文学作品",
        desc: "Achieved a personal record by reading over 5.23 million words, demonstrating dedication to literary exploration.",
        desc_zh:
          "创下个人记录，累计阅读超过 523 万字，展现对文学探索的坚定投入。",
        major: true,
        tag: "Think",
      },
      {
        date: "2026-03-07",
        title: "First Stickman Charles Essay Published",
        title_zh: "Stickman Charles首篇文章出炉",
        desc: "Published my first essay as Stickman Charles, marking a new chapter in writing.",
        desc_zh: "以Stickman Charles身份发表首篇文章，开启写作新篇章。",
        major: true,
        tag: "Think",
      },
      {
        date: "2026-03-15",
        title: "EchoForge Live on Cardano Preprod Testnet",
        title_zh: "EchoForge 上线Cardano Preprod Testnet",
        desc: "Launched EchoForge on Cardano's Preprod testnet, marking a major milestone in blockchain-based content platform development.",
        desc_zh:
          "EchoForge 正式上线 Cardano Preprod Testnet，标志着区块链内容平台开发的重要里程碑。",
        major: true,
        tag: "Blockchain",
      },
      {
        date: "2026-03-18",
        title: "Cardano Daily News Agent Launched",
        title_zh: "Cardano 每日新闻 Agent 上线",
        desc: "Launched Cardano Intel Agent, an AI-powered blockchain intelligence system orchestrated by CrewAI and powered by Llama 3. Monitors Cardano (ADA) technical developments (GitHub commits, protocol updates), market sentiment (Fear & Greed Index), and on-chain dynamics in real-time. Fully local execution on Mac Mini, zero external API dependencies, privacy-first architecture. Auto-generates timestamped Markdown research reports and sends daily briefings to email.",
        desc_zh:
          "发布 Cardano Intel Agent，一套由 CrewAI 编排、Llama 3 驱动的 AI 区块链情报系统。实时监控 Cardano (ADA) 的技术动态（GitHub 提交、协议更新）、市场情绪（恐惧与贪婪指数）和链上数据。完全本地化执行，零外部 API 依赖，隐私优先架构。自动生成带时间戳的 Markdown 研报并发送日度简报至邮箱。",
        major: true,
        tag: "AI",
      },
      {
        date: "2026-04-04",
        title: "Completed Integrated Math II Honors",
        title_zh: "完成 Integrated Math II 荣誉课程",
        desc: "Completed the Integrated Math II Honors course.",
        desc_zh: "完成 Integrated Math II 荣誉课程。",
        major: true,
        tag: "MATH",
      },
    ],
...
function initPanel() {
  ...
  const openPanel = (moduleKey) => {
    ...
    document.getElementById("panel-tag-label").textContent = t(
      meta.tag,
      meta.tag_zh,
    );
    ...
    if (moduleKey === "projects") {
      body.innerHTML = buildProjects();
      bindProjectDetailBtns();
    }
    if (moduleKey === "essays") {
      body.innerHTML = buildEssays();
      bindEssayToggle();
    }
    if (moduleKey === "milestone") body.innerHTML = buildMilestone();
    if (moduleKey === "review") {
      body.innerHTML = buildReview();
      initRadarChart();
    }
...
function buildEssays() {
  ...
  const essaysHtml = ESSAYS.map((e, i) =>
    e.type === "essay" ? renderItem(e, i) : "",
  )
    .filter(Boolean)
    .join("");

  const notesHtml = ESSAYS.map((e, i) =>
    e.type === "note" ? renderItem(e, i) : "",
  )
    .filter(Boolean)
    .join("");
...
function _removeEssayScrollListeners() {
  ...
  if (!pb) return;
  if (_efrScrollListeners.wheel) {
    pb.removeEventListener("wheel", _efrScrollListeners.wheel);
    _efrScrollListeners.wheel = null;
  }
  if (_efrScrollListeners.touchStart) {
    pb.removeEventListener("touchstart", _efrScrollListeners.touchStart);
    _efrScrollListeners.touchStart = null;
  }
  if (_efrScrollListeners.touchMove) {
    pb.removeEventListener("touchmove", _efrScrollListeners.touchMove);
    _efrScrollListeners.touchMove = null;
  }
}
...
function _ensureEssayFullscreenDOM() {
  ...
  // close button
  document
    .getElementById("efr-close")
    .addEventListener("click", closeEssayFullscreen);
...
function openEssayFullscreen(idx) {
  ...
  document.getElementById("efr-date").textContent = [essay.date, essay.readTime]
    .filter(Boolean)
    .join(" · ");
...
function bindEssayToggle() {
  document.querySelectorAll(".essay-header").forEach((header) => {
    header.addEventListener("click", () => {
      ...
      _removeEssayScrollListeners();
      document
        .querySelectorAll(".essay-item.expanded")
      ...
      if (!wasOpen) {
        ...
        setTimeout(() => {
          ...
          pb.addEventListener("wheel", _efrScrollListeners.wheel, {
            passive: true,
          });
          pb.addEventListener("touchstart", _efrScrollListeners.touchStart, {
            passive: true,
          });
          pb.addEventListener("touchmove", _efrScrollListeners.touchMove, {
            passive: true,
          });
...
function buildReview() {
  const dimRows = REVIEW_DATA.dims
    .map(
      (d) => `
