...
[→ 加入 EchoForge Discord](https://discord.gg/8tjzmjQmpW)`,
  ...
  },
  {
    ...
    url: '#',
    detail: `# Family Dashboard\n\n**Status:** ONGOING\n**Stack:** Planning · Productivity · Household Systems\n\n## Overview\nFamily Dashboard is a toolbox for organizing household life. The idea is to make recurring chores, schedules, reminders, shared notes, and small administrative tasks easier to track and harder to forget.\n\n## Core Ideas\n- Shared household task management\n- Calendar and reminder coordination\n- Documents and important information in one place\n- Simple systems that reduce family friction\n\n## Goal\nBuild a calm, structured system for the everyday things families usually manage by memory, messages, and scattered notes.`,
    detail_zh: `# Family Dashboard\n\n**状态：** 持续进行\n**技术栈：** 规划 · 生产力 · 家庭系统\n\n## 概览\nFamily Dashboard 是一个用于组织家庭生活的工具箱。它的目标是让重复琐事、日程安排、提醒、共享笔记和小型行政事务更容易被追踪，也更不容易被忘记。\n\n## 核心想法\n- 共享家庭任务管理\n- 日历与提醒协同\n- 重要文档和信息统一收纳\n- 用简单系统减少家庭协作摩擦\n\n## 目标\n把家庭日常里那些通常靠记忆、聊天记录和零散笔记管理的事情，变成一个冷静、结构化的系统。`,
  },
];
